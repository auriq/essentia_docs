...
We have Essentia group all ``.zip`` files in the 'my-zip-data' bucket into a single category (line 4),
and then use the stream command (line 7) to convert the files one by one, pushing the converted files into
